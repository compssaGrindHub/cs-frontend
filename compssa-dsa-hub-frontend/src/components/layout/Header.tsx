...
import { Search, Bell, CheckCircle2, Trophy, Calendar, TrendingUp, AlertTriangle, Info } from 'lucide-react';
...
import { getNotifications, getUnreadCount, markNotificationAsRead, markAllNotificationsAsRead, Notification } from '@/lib/api/notifications';
...
export default function Header() {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.metadata) {
      ...
      } else if (notification.metadata.problemId || notification.metadata.problemSlug) {
        router.push(`/problems/${notification.metadata.problemSlug || notification.metadata.problemId}`);
