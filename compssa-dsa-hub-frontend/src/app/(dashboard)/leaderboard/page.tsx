      ...
      <div className="max-w-7xl mx-auto space-y-4 md:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs md:text-sm text-muted-foreground">
              Track how you rank against the community.
            </p>
          </div>
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full h-9 md:h-10 pl-10 pr-4 bg-card border border-border rounded-lg text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <Tabs
            value={timeFilter}
            onValueChange={(value) =>
              setTimeFilter(value as "all-time" | "monthly" | "weekly")
            }
          >
            <TabsList className="bg-card border border-border w-full sm:w-auto">
              <TabsTrigger
                value="all-time"
                className="flex-1 sm:flex-none text-xs sm:text-sm data-[state=active]:bg-white data-[state=active]:text-black"
              >
                All Time
              </TabsTrigger>
              <TabsTrigger
          ...
          <div className="flex items-center gap-2">
            <Select value={topicFilter} onValueChange={setTopicFilter}>
              <SelectTrigger className="w-[120px] md:w-[140px] bg-card border-border text-foreground text-xs md:text-sm">
                    ...
                    >
                      ...
                      <div className="col-span-1 flex items-center gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`font-medium ${entry.rank <= 3 ? "text-foreground" : "text-muted-foreground"}`}
                          >
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex items-center gap-1.5 min-w-[50px]">
                        {getRankIcon(entry.rank)}
                        <span
                          className={`font-bold ${entry.rank <= 3 ? "text-foreground" : "text-muted-foreground"}`}
                        >
                          #{entry.rank}
                        </span>
                      </div>
            ...
            <div className="flex items-center gap-2">
              ...
              {currentUser && meta.userRank && (
                <Button
                  variant="outline"
                  size="sm"
                  className="ml-2 md:ml-4 border-border text-foreground hover:bg-foreground/5 text-xs"
                  onClick={() => setPage(Math.ceil(meta.userRank! / limit))}
                >
                  <span className="hidden sm:inline">Jump to </span>My Rank
                </Button>
              )}
            </div>
          </div>
