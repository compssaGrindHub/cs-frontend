...
const accentOptions = [
  { id: 'blue', label: 'Blue', primary: '221.2 83.2% 53.3%', foreground: '210 40% 98%', ring: undefined, swatchClass: 'bg-blue-600' },
  { id: 'purple', label: 'Purple', primary: '262.1 83.3% 57.8%', foreground: '210 40% 98%', ring: undefined, swatchClass: 'bg-purple-600' },
  { id: 'pink', label: 'Pink', primary: '330 81% 60%', foreground: '210 40% 98%', ring: undefined, swatchClass: 'bg-pink-500' },
  { id: 'red', label: 'Red', primary: '0 84.2% 60.2%', foreground: '210 40% 98%', ring: undefined, swatchClass: 'bg-red-600' },
  { id: 'orange', label: 'Orange', primary: '24.6 95% 53.1%', foreground: '210 40% 98%', ring: undefined, swatchClass: 'bg-orange-500' },
  { id: 'green', label: 'Green', primary: '142.1 70.6% 45.3%', foreground: '210 40% 98%', ring: undefined, swatchClass: 'bg-green-600' },
];
...
export default function AdminSettingsPage() {
  ...
  const [bio, setBio] = useState('Administrator for the DSA Hub.');
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground">Manage admin profile, preferences, and settings.</p>
        </div>
          ...
          <div className="lg:col-span-3">
                ...
                <Card className="bg-card border-border">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      This information will be displayed on your admin profile.
                    </p>
              ...
              <div className="space-y-6">
                <Card className="bg-card border-border">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-6">Choose how the admin panel should look.</p>
                ...
                <Card className="bg-card border-border">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-6">Customize the color scheme of the admin panel.</p>
            ...
            <Card className="bg-destructive/10 border-destructive/20 mt-8">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">Irreversible actions for your admin account.</p>
                <Button className="border border-destructive/50 text-destructive hover:bg-destructive/10 gap-2">
                  <Trash2 className="w-4 h-4" />
                  Delete Admin Account
                </Button>
                <p className="text-xs text-muted-foreground mt-2">Permanently removes your admin account and all data.</p>
              </CardContent>
            </Card>
          </div>
        </div>
